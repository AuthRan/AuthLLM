...
**Status:** 🟢 **running** — step **17,533 / 20,000** (87.7%)
...
| **Training loss** | 3.1783 (learning rate 8.09e-05) |
| **Validation loss** | 3.1726 (perplexity 23.87) at step 17,500 |
| **Tokens seen** | 2.15B (122,880 per step) |
| **Throughput** | 4.91 s/step (25,007 tokens/s) |
| **Hardware** | 1x RTX 2080 Ti (11GB), fp16 + GradScaler |
| **Estimated remaining** | ~3h 22m (≈ 2026-08-18 06:39 IST) |
| **Last updated** | 2026-08-18 03:17 IST |
