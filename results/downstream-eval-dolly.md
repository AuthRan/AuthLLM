...
300 held-out examples (seed 1337, val fraction 0.02); loss over 40 batches of 8; generations from the first 40 held-out prompts at temperature 0.8, top_k 50, repetition penalty 1.0, cap 200 tokens.

| checkpoint | held-out loss | ppl | stop rate | mean tokens | loop rate |
| --- | ---: | ---: | ---: | ---: | ---: |
| `base` | 3.0653 | 21.44 | 30% | 179 | 80% |
| `A_padded_optimum` | 2.9518 | 19.14 | 100% | 49 | 5% |
| `B_packed_inherited` | 2.8873 | 17.94 | 98% | 55 | 5% |
| `C_packed_retuned` | 2.9739 | 19.57 | 95% | 51 | 10% |
...
> Sacrament court, Sacramento's annual NBA playoffs, is so important for the health and safety of our team and fans. It gives us a chance to get to know our players, and they are always there for us for fun and laughter.
...
> Barton's political life lasted for three years. During this time he was elected to the House of Representatives and Senate. After becoming an anti-Jacksonian, he was defeated in the House of Representatives and Senate. He was re-elected to the Senate after a two-year term.
